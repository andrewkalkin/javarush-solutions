...
public class LogParser implements IPQuery, UserQuery, DateQuery, EventQuery, QLQuery {
    ...
    public int getNumberOfUserEvents(String user, Date after, Date before) {
        ...
        for (LogRecord logRecord: getParsedRecords(logDir)) {
            if (isDateInside(after, before, logRecord.getDate()) && logRecord.getUser().equals(user))  events.add(logRecord.getEvent());
        }
    ...
    public Set<String> getUsersForIP(String ip, Date after, Date before) {
        Set<String> users = new HashSet<>();
        for (LogRecord logRecord: getParsedRecords(logDir)) {
            if (isDateInside(after, before, logRecord.getDate()) && logRecord.getIp().equals(ip))  users.add(logRecord.getUser());
        }
        return users;
    }
    ...
    public Set<String> getLoggedUsers(Date after, Date before) {
        Set<String> users = new HashSet<>();
        for (LogRecord logRecord: getParsedRecords(logDir)) {
            if (isDateInside(after, before, logRecord.getDate()) && logRecord.getEvent().equals(Event.LOGIN))  users.add(logRecord.getUser());
        }
        return users;
    }
    ...
    public Set<String> getDownloadedPluginUsers(Date after, Date before) {
        Set<String> users = new HashSet<>();
        for (LogRecord logRecord: getParsedRecords(logDir)) {
            if (isDateInside(after, before, logRecord.getDate()) && logRecord.getEvent().equals(Event.DOWNLOAD_PLUGIN))  users.add(logRecord.getUser());
        }
        return users;
    }
    ...
    public Set<String> getWroteMessageUsers(Date after, Date before) {
        Set<String> users = new HashSet<>();
        for (LogRecord logRecord: getParsedRecords(logDir)) {
            if (isDateInside(after, before, logRecord.getDate()) && logRecord.getEvent().equals(Event.WRITE_MESSAGE))  users.add(logRecord.getUser());
        }
        return users;
    }
    ...
    public Set<String> getSolvedTaskUsers(Date after, Date before) {
        Set<String> users = new HashSet<>();
        for (LogRecord logRecord: getParsedRecords(logDir)) {
            if (isDateInside(after, before, logRecord.getDate()) && logRecord.getEvent().equals(Event.SOLVE_TASK))  users.add(logRecord.getUser());
        }
        return users;
    }
    ...
    public Set<String> getSolvedTaskUsers(Date after, Date before, int task) {
        Set<String> users = new HashSet<>();
        for (LogRecord logRecord: getParsedRecords(logDir)) {
            if (isDateInside(after, before, logRecord.getDate()) && logRecord.getEvent().equals(Event.SOLVE_TASK) &&
    ...
    public Set<String> getDoneTaskUsers(Date after, Date before) {
        Set<String> users = new HashSet<>();
        for (LogRecord logRecord: getParsedRecords(logDir)) {
            if (isDateInside(after, before, logRecord.getDate()) && logRecord.getEvent().equals(Event.DONE_TASK))  users.add(logRecord.getUser());
        }
        return users;
    }
    ...
    public Set<String> getDoneTaskUsers(Date after, Date before, int task) {
        ...
        Set<String> users = new HashSet<>();
        for (LogRecord logRecord: getParsedRecords(logDir)) {
            if (isDateInside(after, before, logRecord.getDate()) && logRecord.getEvent().equals(Event.DONE_TASK) &&
                    logRecord.getTaskNumber() != null &&
                    !logRecord.getTaskNumber().isEmpty() &&
                    Integer.parseInt(logRecord.getTaskNumber()) == task)  users.add(logRecord.getUser());
        }
    ...
    public Date getDateWhenUserSolvedTask(String user, int task, Date after, Date before) {
        ...
        for (LogRecord logRecord: getParsedRecords(logDir)) {
            if (isDateInside(after, before, logRecord.getDate()) &&
                    ...
                    logRecord.getEvent().equals(Event.SOLVE_TASK) &&
                    logRecord.getTaskNumber() != null &&
                    !logRecord.getTaskNumber().isEmpty() &&
    ...
    public Date getDateWhenUserDoneTask(String user, int task, Date after, Date before) {
        ...
        for (LogRecord logRecord: getParsedRecords(logDir)) {
            if (isDateInside(after, before, logRecord.getDate()) &&
                    logRecord.getUser().equals(user) &&
                    logRecord.getEvent().equals(Event.DONE_TASK) &&
                    logRecord.getTaskNumber() != null &&
                    !logRecord.getTaskNumber().isEmpty() &&
                    Integer.parseInt(logRecord.getTaskNumber()) == task)
                if (date == null) date = logRecord.getDate(); else
    ...
    public Set<Date> getDatesWhenUserWroteMessage(String user, Date after, Date before) {
        Set<Date> dates = new HashSet<>();
        for (LogRecord logRecord: getParsedRecords(logDir)) {
            if (isDateInside(after, before, logRecord.getDate()) && logRecord.getEvent().equals(Event.WRITE_MESSAGE) && logRecord.getUser().equals(user)) dates.add(logRecord.getDate());
        }
        return dates;
    }
    ...
    public Set<Event> getAllEvents(Date after, Date before) {
        Set<Event> events = new HashSet<>();
        for (LogRecord logRecord: getParsedRecords(logDir)) {
            if (isDateInside(after, before, logRecord.getDate())) events.add(logRecord.getEvent());
        }
        return events;
    }
